<template>
  ...
  <div class="container">
    ...
    <div class="content-body p-5">
      <div class="relative">
          <form @submit.prevent=" store.updateCategory(category) " enctype="multipart/form-data">
              ...
              <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                  <FileUpload :multiple="false" v-model="store.form.image_path" :selectedFile="props.category.image_path"/>
...
watch(
  () => store.form.name,
  (newVale) => {
    store.form.slug = generateSlug(newVale);
  }
);
</script>
