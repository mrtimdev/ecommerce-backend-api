<template>
  <DefaultLayout>
    <Head :title="$t('driver.add')" />
    <div class="container">
      <div
        class="content-header p-5 rounded-tl-md rounded-tr-md py-4 bg-white dark:bg-boxdark-1 flex flex-grow items-center justify-between"
      >
        <div
          class="flex justify-start items-center gap-1 text-sm font-medium text-gray-700 dark:text-white"
        >
          <i class="fa fa-pencil w-4 h-4"></i> {{ $t("driver.edit") }}
        </div>
      </div>
        ...
        <div class="relative">
          <form @submit.prevent="handleSubmit" enctype="multipart/form-data">
            <div class="grid grid-cols-12 gap-4">
              <!-- Column -->
              <div
                class="col-span-12 md:col-span-8 p-4 border dark:border-gray-700 rounded-lg"
              >
                <div
              ...
              <!-- Column -->
              <div
                class="col-span-12 md:col-span-4 p-4 border dark:border-gray-700 rounded-lg"
              >
                <div>
                  <Label
                    for_id="avatar"
                  ...
                  <FileUpload
                    v-model="form.avatar"
                    target_input="avatar"
                    :selectedFile="props.driver.avatar"
                  />
...
form.username = props.driver.username;
form.email = props.driver.email;
form.phone = props.driver.phone;
form.is_active = props.driver.is_active;
  ...
  form.post(route("drivers.update", props.driver.id), {
    ...
    onSuccess: (res) => {
      events.emit("toaster", {
        type: "success",
        action: "create",
        message: `${t("driver")} [${form.first_name} ${form.last_name}] ${t(
