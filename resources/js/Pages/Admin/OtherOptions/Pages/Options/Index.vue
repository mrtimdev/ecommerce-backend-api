<template>
  <LayoutTab>
    ...
    <div class="">
      ...
      <div class="relative">
        <table id="option" class="table w-full text-sm text-left rtl:text-right">
          <thead class="text-center bg-white dark:bg-boxdark">
            <tr>
              ...
              <th class="w-[30%]">{{ $t("models") }}</th>
              <th class="w-[17%]">{{ $t("group_name") }}</th>
    ...
    <AddOrEdit :show-modal="false" :optionGroups="optionGroups" :models="models" />
  </LayoutTab>
</template>
...
onMounted(() => {
  tableData.value = $("#option").DataTable({
    ...
    columns: [
      ...
      { data: "code", name: "code" },
      { data: "name", name: "name" },
      { data: "models_name", name: "models_name" },
