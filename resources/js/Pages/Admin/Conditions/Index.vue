  ...
  <DefaultLayout>
    ...
    <div class="container">
      ...
      <div class="content-body p-5">
        <div class="relative">
          <table id="car-condition" class="table w-full text-sm text-left rtl:text-right">
...
events.on('confirm:confirmed', (data) => {
  ...
  conditionStore.deleteConditions(items);
})
