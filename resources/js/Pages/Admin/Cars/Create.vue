...
const form = useForm({
  ...
  engine_power: "",
  odometer_reading: "",
  water_flood_damaged: false,
  former_rental_car: false,
  former_taxi: false,
  recovered_theft: false,
  police_car: false,
  salvage_record: false,
  fuel_conversion: false,
  modified_seats: false,
