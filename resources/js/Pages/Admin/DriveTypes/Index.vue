  ...
  <DefaultLayout>
    ...
    <div class="container">
      ...
      <div class="content-body p-5">
        <div class="relative">
          <table id="drive_types" class="table w-full text-sm text-left rtl:text-right">
...
const openModalForm = () => {
  events.emit('modal:open', {
    modal_title: "drive_type.add",
    event_type: "add",
  });
}
const breadcrumbs = reactive([
  { label: "Home", url: route("dashboard") },
  { label: t("drive_types"), url: null },
...
onMounted(() => {
  tableData.value = $("#drive_types").DataTable({
    processing: true,
    serverSide: true,
    pageLength: 10,
    order: [[1, "desc"]],
