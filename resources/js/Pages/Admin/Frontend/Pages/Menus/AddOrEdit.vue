        ...
        <form @submit.prevent="menuFormSubmit" enctype="multipart/form-data">
          <div class="p-4 md:p-5">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
              ...
              <div>
                <Label :isRequired="true" for_id="name"> {{ $t("name") }}</Label>
                <input
                  type="text"
                  id="name"
                  ref="name"
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
              <div>
                <Label for_id="brands"> {{ $t("brands") }}</Label>
                <MultiSelect
                  id="brands"
                  v-model="form.brands"
                  :options="brands"
              ...
              <div>
                <Label for_id="category"> {{ $t("category") }}</Label>
                <MultiSelect
                  id="category"
              ...
              <div>
                <Label for_id="models"> {{ $t("models") }}</Label>
                <MultiSelect
                  id="models"
                  v-model="form.models"
                  :options="models"
              ...
              <div>
                <Label for_id="fuel_types"> {{ $t("fuel_types") }}</Label>
                <MultiSelect
                  id="fuel_types"
              ...
              <div>
                <Label for_id="steerings"> {{ $t("steerings") }}</Label>
                <MultiSelect
                  id="steerings"
              ...
              <div>
                <Label for_id="drive_types"> {{ $t("drive_types") }}</Label>
                <MultiSelect
                  id="drive_types"
              ...
              <div>
                <Label for_id="passengers"> {{ $t("passengers") }}</Label>
                <MultiSelect
                  id="passengers"
              ...
              <div>
                <Label for_id="locations"> {{ $t("locations") }}</Label>
                <MultiSelect
                  id="locations"
