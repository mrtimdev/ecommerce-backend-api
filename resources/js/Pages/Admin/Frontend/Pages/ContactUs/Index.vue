      ...
      <div class="relative">
        <form @submit.prevent="contactUsStore" enctype="multipart/form-data" class="mt-4">
          ...
          >
            ...
            <div>
              <Label
                for_id="telegram_channel"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                >{{ $t("telegram_channel") }}</Label
              >
              <input
                type="text"
                id="telegram_channel"
                ref="telegram_channel"
            ...
            <div>
              <Label
                for_id="facebook_page"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                >{{ $t("facebook_page") }}</Label
              >
              <input
                type="text"
                id="facebook_page"
          ...
          <div
            class="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 mt-4"
          >
            <div class="mb-6">
              <Label
                for_id="address"
