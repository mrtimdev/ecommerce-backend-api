...
const menuGroups = ref([
    {
        ...
        },
        {
            ...
            label: 'Settings',
            children: [
                { icon: `<i class="fa-sharp fa-circle-dot"></i>`, label: 'Settings', routeName: 'cars.list' },
            ]
        },
...
<template>
  ...
  >
    <!-- SIDEBAR HEADER -->
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6 shadow-2 dark:bg-[#1a2035] bg-[#f9fbfd]">
      <Link href="/dashboard">
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
      ...
      >
        <h3 class="mb-1 font-semibold text-white">Movie Zone Pro </h3>
        <p class="mb-4 text-xs">Get All dashboards and 300+ UI Elements</p>
        <a
          href="https://moviezone.com/pricing"
          target="_blank"
          rel="nofollow"
